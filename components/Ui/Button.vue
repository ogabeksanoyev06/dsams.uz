<template>
  ...
  >
    ...
    <slot>
      <Icon v-if="loading" class="size-5 animate-spin" name="lucide:loader-pinwheel" />
...
<script setup lang="ts">
  ...
  const forwarded = useForwardProps(reactiveOmit(props, "class", "text", "icon", "iconPlacement", "size", "variant", "as", "loading", "disabled"));
</script>
