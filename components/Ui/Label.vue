...
<script lang="ts" setup>
  ...
  const styles = tv({
    base: "flex items-center justify-between text-sm font-medium leading-none hover:cursor-pointer peer-disabled:cursor-not-allowed peer-disabled:opacity-70 sm:text-sm",
  });
</script>
