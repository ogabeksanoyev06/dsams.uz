<template>
  <div ref="target" class="relative" data-dropdown="0" tabindex="0">
    ...
    <Transition name="dropdown" mode="out-in">
      <div v-if="showBody" class="absolute right-0 w-max min-w-full translate-y-full border border-gray-6 bg-white rounded-lg overflow-hidden z-[11] shadow-md -bottom-1" :class="[bodyClass]" data-dropdown-body>
        <slot name="body" />
      </div>
    </Transition>
  </div>
